...
void Draw_Cross(uint16_t Xpos, uint16_t Ypos, uint16_t in_color, uint16_t out_color)
{
  Draw_Line(Xpos-15,Ypos,Xpos-2,Ypos,in_color);
  Draw_Line(Xpos+2,Ypos,Xpos+15,Ypos,in_color);
  Draw_Line(Xpos,Ypos-15,Xpos,Ypos-2,in_color);
  Draw_Line(Xpos,Ypos+2,Xpos,Ypos+15,in_color);

  Draw_Line(Xpos-15,Ypos+15,Xpos-7,Ypos+15,out_color);
  Draw_Line(Xpos-15,Ypos+7,Xpos-15,Ypos+15,out_color);

  Draw_Line(Xpos-15,Ypos-15,Xpos-7,Ypos-15,out_color);
  Draw_Line(Xpos-15,Ypos-7,Xpos-15,Ypos-15,out_color);

  Draw_Line(Xpos+7,Ypos+15,Xpos+15,Ypos+15,out_color);
  Draw_Line(Xpos+15,Ypos+7,Xpos+15,Ypos+15,out_color);

  Draw_Line(Xpos+7,Ypos-15,Xpos+15,Ypos-15,out_color);
  Draw_Line(Xpos+15,Ypos-15,Xpos+15,Ypos-7,out_color);
}
...
void Init_GPIO(void)
{
 ...
 init.GPIO_PuPd = GPIO_PuPd_UP;
  ...
  //-----------------------------------------
    ...
    //-----------------------------------------
  init.GPIO_Pin = GPIO_Pin_1;              //PB1 -> enable Backlight
  init.GPIO_Mode = GPIO_Mode_OUT;
  init.GPIO_OType = GPIO_OType_PP;
  init.GPIO_PuPd = GPIO_PuPd_UP;
  init.GPIO_Speed = GPIO_Speed_50MHz;
  ...
  GPIO_PinAFConfig(GPIOD, GPIO_PinSource13, GPIO_AF_FSMC);    // A18 -> RS
